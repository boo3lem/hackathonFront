  ...
  static getStands() {
    ...
    expo.add(
      Exposant(
          3,
          "BMS Electric",
          "La société BMS ELECTRIC s’est engagée depuis  2001 dans la fabrication des accessoires et de l’appareillage électrique.\nSon personnel, hautement qualifié, se distingue par sa rapidité d’exécution et sa capacité à satisfaire les différentes exigences de ces clients et leur fournir une gamme de produits variée.\nAprès seulement quatre années d’activité, la société devient le leader du marché algérien et ses produits sont distribués dans plusieurs pays étrangers.\nAvec le projet d’extension, BMS prévoit la création d’une centaine de nouveaux postes d’emploi ainsi que plusieurs autres chaines de fabrication entrant dans le cadre de la redynamisation du potentiel productif.\nLes efforts de l’équipe dirigeante de BMS ont amené cette dernière au stade de ‘’société industrielle’’ aujourd’hui fleuron de l’économie nationale.",
          "bms-electric.com",
          "assets/bms.png"),
    );
    expo.add(
